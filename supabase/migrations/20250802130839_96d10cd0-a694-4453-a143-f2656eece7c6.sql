-- Enhanced database schema for comprehensive onboarding and user management
...
-- Create contact submissions table (from previous)
...
('Personal', 2900, 29000, '["Global threat map access", "Personal alert system", "Basic resilience toolkit", "24/7 threat monitoring", "Mobile app access"]', 1, 1, 'Perfect for individuals and families seeking personal preparedness'),
('Professional', 9900, 99000, '["Everything in Personal", "Advanced threat analytics", "Custom alert zones", "Threat correlation engine", "DisruptionOS access", "Email & SMS alerts", "Priority support"]', 5, 1, 'Ideal for small businesses and professional users'),
('Enterprise', 39900, 399000, '["Everything in Professional", "Multi-user collaboration", "Custom integrations", "Advanced reporting", "Dedicated account manager", "API access", "Custom training", "White-label options"]', 999, 10, 'Comprehensive solution for large organizations');
...
-- Enable realtime for threat signals (for real-time updates)
