...
import { Globe, Map, Filter, ChevronDown, ChevronUp } from 'lucide-react';
      ...
      <div className="absolute top-4 lg:top-6 left-4 lg:left-6 right-4 lg:right-auto z-50 space-y-3 lg:space-y-4 max-w-xs lg:max-w-none">
        ...
        <div className="glass-panel rounded-lg p-2">
          <CollapsibleTrigger asChild>
            <Button
              variant="ghost"
              className="w-full flex items-center justify-between text-starlink-white hover:bg-starlink-blue/20"
            >
              <span className="text-xs lg:text-sm font-medium">Map Controls</span>
              {isCollapsed ? (
